<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Navbar.Master" AutoEventWireup="true" CodeBehind="UpdateMakeup.aspx.cs" Inherits="PSD_ProjectLab.Views.Admin.UpdateMakeup" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Button ID="back_btn" runat="server" Text="Back" OnClick="back_btn_Click"/>
    <br />
    <h1>Update Makeups</h1>
    <div>
